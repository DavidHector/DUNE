#ifndef Udune_ftworth_heterogeneousproblem_HH
#define Udune_ftworth_heterogeneousproblem_HH
...
public:
  ...
  A (const typename Traits::ElementType& e, const typename Traits::DomainType& x) const
  {
    ...
    if (xglobal[1] < (i+0.5)*0.1 && xglobal[1] >(i)*0.1 && xglobal[0] > 0.1 && xglobal[0] < 0.9)
      k = 10000;
    }
